...
- 🎒 Desenvolvedor Back-end (Java, Python, Node.js, C++).
- ❄️ Desenvolvedor Front-end (HTML, JavaScript, React).
- 👯 Estou buscando colaborar em projetos Open Source de automação e sistemas distribuídos.
- 🤔 Procuro ajuda com arquitetura de microsserviços e WebAssembly (Wasm).
- 💬 Desenvolvimento de scripts em Lua ou APIs em Python/Node.
...
🤝 Sempre aberto para colaborações, parcerias e ideias legais
